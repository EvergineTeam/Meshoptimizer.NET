...
namespace Evergine.Bindings.MeshOptimizer
{
	public static unsafe partial class MeshOptNative
	{
		...
		public static extern nuint meshopt_generateVertexRemap(uint* destination, uint* indices, nuint index_count, void* vertices, nuint vertex_count, nuint vertex_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_generateVertexRemapMulti(uint* destination, uint* indices, nuint index_count, nuint vertex_count, meshopt_Stream* streams, nuint stream_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_remapVertexBuffer(void* destination, void* vertices, nuint vertex_count, nuint vertex_size, uint* remap);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_remapIndexBuffer(uint* destination, uint* indices, nuint index_count, uint* remap);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_generateShadowIndexBuffer(uint* destination, uint* indices, nuint index_count, void* vertices, nuint vertex_count, nuint vertex_size, nuint vertex_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_generateShadowIndexBufferMulti(uint* destination, uint* indices, nuint index_count, nuint vertex_count, meshopt_Stream* streams, nuint stream_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_generateAdjacencyIndexBuffer(uint* destination, uint* indices, nuint index_count, float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_generateTessellationIndexBuffer(uint* destination, uint* indices, nuint index_count, float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_generateProvokingIndexBuffer(uint* destination, uint* reorder, uint* indices, nuint index_count, nuint vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_optimizeVertexCache(uint* destination, uint* indices, nuint index_count, nuint vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_optimizeVertexCacheStrip(uint* destination, uint* indices, nuint index_count, nuint vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_optimizeVertexCacheFifo(uint* destination, uint* indices, nuint index_count, nuint vertex_count, uint cache_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_optimizeOverdraw(uint* destination, uint* indices, nuint index_count, float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride, float threshold);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_optimizeVertexFetch(void* destination, uint* indices, nuint index_count, void* vertices, nuint vertex_count, nuint vertex_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_optimizeVertexFetchRemap(uint* destination, uint* indices, nuint index_count, nuint vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_encodeIndexBuffer(byte* buffer, nuint buffer_size, uint* indices, nuint index_count);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_encodeIndexBufferBound(nuint index_count, nuint vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern int meshopt_decodeIndexBuffer(void* destination, nuint index_count, nuint index_size, byte* buffer, nuint buffer_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_encodeIndexSequence(byte* buffer, nuint buffer_size, uint* indices, nuint index_count);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_encodeIndexSequenceBound(nuint index_count, nuint vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern int meshopt_decodeIndexSequence(void* destination, nuint index_count, nuint index_size, byte* buffer, nuint buffer_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_encodeVertexBuffer(byte* buffer, nuint buffer_size, void* vertices, nuint vertex_count, nuint vertex_size);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_encodeVertexBufferBound(nuint vertex_count, nuint vertex_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern int meshopt_decodeVertexBuffer(void* destination, nuint vertex_count, nuint vertex_size, byte* buffer, nuint buffer_size);
		...
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_encodeFilterExp(void* destination, nuint count, nuint stride, int bits, float* data, meshopt_EncodeExpMode mode);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_simplify(uint* destination, uint* indices, nuint index_count, float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride, nuint target_index_count, float target_error, uint options, float* result_error);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_simplifySloppy(uint* destination, uint* indices, nuint index_count, float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride, nuint target_index_count, float target_error, float* result_error);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_simplifyPoints(uint* destination, float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride, float* vertex_colors, nuint vertex_colors_stride, float color_weight, nuint target_vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern float meshopt_simplifyScale(float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_stripify(uint* destination, uint* indices, nuint index_count, nuint vertex_count, uint restart_index);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_stripifyBound(nuint index_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_unstripify(uint* destination, uint* indices, nuint index_count, uint restart_index);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_unstripifyBound(nuint index_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern meshopt_VertexCacheStatistics meshopt_analyzeVertexCache(uint* indices, nuint index_count, nuint vertex_count, uint cache_size, uint warp_size, uint primgroup_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern meshopt_OverdrawStatistics meshopt_analyzeOverdraw(uint* indices, nuint index_count, float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern meshopt_VertexFetchStatistics meshopt_analyzeVertexFetch(uint* indices, nuint index_count, nuint vertex_count, nuint vertex_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_buildMeshlets(meshopt_Meshlet* meshlets, uint* meshlet_vertices, byte* meshlet_triangles, uint* indices, nuint index_count, float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride, nuint max_vertices, nuint max_triangles, float cone_weight);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_buildMeshletsScan(meshopt_Meshlet* meshlets, uint* meshlet_vertices, byte* meshlet_triangles, uint* indices, nuint index_count, nuint vertex_count, nuint max_vertices, nuint max_triangles);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern nuint meshopt_buildMeshletsBound(nuint index_count, nuint max_vertices, nuint max_triangles);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_optimizeMeshlet(uint* meshlet_vertices, byte* meshlet_triangles, nuint triangle_count, nuint vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern meshopt_Bounds meshopt_computeClusterBounds(uint* indices, nuint index_count, float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern meshopt_Bounds meshopt_computeMeshletBounds(uint* meshlet_vertices, byte* meshlet_triangles, nuint triangle_count, float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_spatialSortRemap(uint* destination, float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_spatialSortTriangles(uint* destination, uint* indices, nuint index_count, float* vertex_positions, nuint vertex_count, nuint vertex_positions_stride);
