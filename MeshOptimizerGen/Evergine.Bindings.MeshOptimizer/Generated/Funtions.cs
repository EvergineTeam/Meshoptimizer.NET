...
namespace Evergine.Bindings.MeshOptimizer
{
	public static unsafe partial class MeshOptNative
	{
		...
		public static extern ulong meshopt_generateVertexRemap(uint* destination, uint* indices, ulong index_count, void* vertices, ulong vertex_count, ulong vertex_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_generateVertexRemapMulti(uint* destination, uint* indices, ulong index_count, ulong vertex_count, meshopt_Stream* streams, ulong stream_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_remapVertexBuffer(void* destination, void* vertices, ulong vertex_count, ulong vertex_size, uint* remap);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_remapIndexBuffer(uint* destination, uint* indices, ulong index_count, uint* remap);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_generateShadowIndexBuffer(uint* destination, uint* indices, ulong index_count, void* vertices, ulong vertex_count, ulong vertex_size, ulong vertex_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_generateShadowIndexBufferMulti(uint* destination, uint* indices, ulong index_count, ulong vertex_count, meshopt_Stream* streams, ulong stream_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_generateAdjacencyIndexBuffer(uint* destination, uint* indices, ulong index_count, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_generateTessellationIndexBuffer(uint* destination, uint* indices, ulong index_count, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_generateProvokingIndexBuffer(uint* destination, uint* reorder, uint* indices, ulong index_count, ulong vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_optimizeVertexCache(uint* destination, uint* indices, ulong index_count, ulong vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_optimizeVertexCacheStrip(uint* destination, uint* indices, ulong index_count, ulong vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_optimizeVertexCacheFifo(uint* destination, uint* indices, ulong index_count, ulong vertex_count, uint cache_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_optimizeOverdraw(uint* destination, uint* indices, ulong index_count, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride, float threshold);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_optimizeVertexFetch(void* destination, uint* indices, ulong index_count, void* vertices, ulong vertex_count, ulong vertex_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_optimizeVertexFetchRemap(uint* destination, uint* indices, ulong index_count, ulong vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_encodeIndexBuffer(byte* buffer, ulong buffer_size, uint* indices, ulong index_count);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_encodeIndexBufferBound(ulong index_count, ulong vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern int meshopt_decodeIndexBuffer(void* destination, ulong index_count, ulong index_size, byte* buffer, ulong buffer_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern int meshopt_decodeIndexVersion(byte* buffer, ulong buffer_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_encodeIndexSequence(byte* buffer, ulong buffer_size, uint* indices, ulong index_count);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_encodeIndexSequenceBound(ulong index_count, ulong vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern int meshopt_decodeIndexSequence(void* destination, ulong index_count, ulong index_size, byte* buffer, ulong buffer_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_encodeVertexBuffer(byte* buffer, ulong buffer_size, void* vertices, ulong vertex_count, ulong vertex_size);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_encodeVertexBufferBound(ulong vertex_count, ulong vertex_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_encodeVertexBufferLevel(byte* buffer, ulong buffer_size, void* vertices, ulong vertex_count, ulong vertex_size, int level);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern int meshopt_decodeVertexBuffer(void* destination, ulong vertex_count, ulong vertex_size, byte* buffer, ulong buffer_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern int meshopt_decodeVertexVersion(byte* buffer, ulong buffer_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_decodeFilterOct(void* buffer, ulong count, ulong stride);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_decodeFilterQuat(void* buffer, ulong count, ulong stride);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_decodeFilterExp(void* buffer, ulong count, ulong stride);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_encodeFilterOct(void* destination, ulong count, ulong stride, int bits, float* data);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_encodeFilterQuat(void* destination, ulong count, ulong stride, int bits, float* data);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_encodeFilterExp(void* destination, ulong count, ulong stride, int bits, float* data, meshopt_EncodeExpMode mode);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_simplify(uint* destination, uint* indices, ulong index_count, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride, ulong target_index_count, float target_error, uint options, float* result_error);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_simplifyWithAttributes(uint* destination, uint* indices, ulong index_count, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride, float* vertex_attributes, ulong vertex_attributes_stride, float* attribute_weights, ulong attribute_count, byte* vertex_lock, ulong target_index_count, float target_error, uint options, float* result_error);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_simplifySloppy(uint* destination, uint* indices, ulong index_count, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride, ulong target_index_count, float target_error, float* result_error);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_simplifyPoints(uint* destination, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride, float* vertex_colors, ulong vertex_colors_stride, float color_weight, ulong target_vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern float meshopt_simplifyScale(float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_stripify(uint* destination, uint* indices, ulong index_count, ulong vertex_count, uint restart_index);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_stripifyBound(ulong index_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_unstripify(uint* destination, uint* indices, ulong index_count, uint restart_index);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_unstripifyBound(ulong index_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern meshopt_VertexCacheStatistics meshopt_analyzeVertexCache(uint* indices, ulong index_count, ulong vertex_count, uint cache_size, uint warp_size, uint primgroup_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern meshopt_OverdrawStatistics meshopt_analyzeOverdraw(uint* indices, ulong index_count, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern meshopt_VertexFetchStatistics meshopt_analyzeVertexFetch(uint* indices, ulong index_count, ulong vertex_count, ulong vertex_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_buildMeshlets(meshopt_Meshlet* meshlets, uint* meshlet_vertices, byte* meshlet_triangles, uint* indices, ulong index_count, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride, ulong max_vertices, ulong max_triangles, float cone_weight);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_buildMeshletsScan(meshopt_Meshlet* meshlets, uint* meshlet_vertices, byte* meshlet_triangles, uint* indices, ulong index_count, ulong vertex_count, ulong max_vertices, ulong max_triangles);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_buildMeshletsBound(ulong index_count, ulong max_vertices, ulong max_triangles);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_buildMeshletsFlex(meshopt_Meshlet* meshlets, uint* meshlet_vertices, byte* meshlet_triangles, uint* indices, ulong index_count, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride, ulong max_vertices, ulong min_triangles, ulong max_triangles, float cone_weight, float split_factor);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_optimizeMeshlet(uint* meshlet_vertices, byte* meshlet_triangles, ulong triangle_count, ulong vertex_count);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern meshopt_Bounds meshopt_computeClusterBounds(uint* indices, ulong index_count, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride);

		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern meshopt_Bounds meshopt_computeMeshletBounds(uint* meshlet_vertices, byte* meshlet_triangles, ulong triangle_count, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern meshopt_Bounds meshopt_computeSphereBounds(float* positions, ulong count, ulong positions_stride, float* radii, ulong radii_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong meshopt_partitionClusters(uint* destination, uint* cluster_indices, ulong total_index_count, uint* cluster_index_counts, ulong cluster_count, ulong vertex_count, ulong target_partition_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_spatialSortRemap(uint* destination, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_spatialSortTriangles(uint* destination, uint* indices, ulong index_count, float* vertex_positions, ulong vertex_count, ulong vertex_positions_stride);
