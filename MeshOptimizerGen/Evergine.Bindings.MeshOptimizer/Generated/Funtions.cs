...
namespace Evergine.Bindings.MeshOptimizer
{
	public static unsafe partial class MeshOptNative
	{
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern UIntPtr meshopt_generateVertexRemapCustom(uint* destination, uint* indices, UIntPtr index_count, float* vertex_positions, UIntPtr vertex_count, UIntPtr vertex_positions_stride, delegate* unmanaged[Cdecl]<void*, uint, uint, int> callback, void* context);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_generatePositionRemap(uint* destination, float* vertex_positions, UIntPtr vertex_count, UIntPtr vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern UIntPtr meshopt_encodeVertexBufferLevel(byte* buffer, UIntPtr buffer_size, void* vertices, UIntPtr vertex_count, UIntPtr vertex_size, int level, int version);
		...
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_decodeFilterColor(void* buffer, UIntPtr count, UIntPtr stride);
		...
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_encodeFilterColor(void* destination, UIntPtr count, UIntPtr stride, int bits, float* data);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern UIntPtr meshopt_simplifyWithUpdate(uint* indices, UIntPtr index_count, float* vertex_positions, UIntPtr vertex_count, UIntPtr vertex_positions_stride, float* vertex_attributes, UIntPtr vertex_attributes_stride, float* attribute_weights, UIntPtr attribute_count, byte* vertex_lock, UIntPtr target_index_count, float target_error, uint options, float* result_error);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern UIntPtr meshopt_simplifySloppy(uint* destination, uint* indices, UIntPtr index_count, float* vertex_positions, UIntPtr vertex_count, UIntPtr vertex_positions_stride, byte* vertex_lock, UIntPtr target_index_count, float target_error, float* result_error);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern UIntPtr meshopt_simplifyPrune(uint* destination, uint* indices, UIntPtr index_count, float* vertex_positions, UIntPtr vertex_count, UIntPtr vertex_positions_stride, float target_error);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern meshopt_CoverageStatistics meshopt_analyzeCoverage(uint* indices, UIntPtr index_count, float* vertex_positions, UIntPtr vertex_count, UIntPtr vertex_positions_stride);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern UIntPtr meshopt_buildMeshletsSpatial(meshopt_Meshlet* meshlets, uint* meshlet_vertices, byte* meshlet_triangles, uint* indices, UIntPtr index_count, float* vertex_positions, UIntPtr vertex_count, UIntPtr vertex_positions_stride, UIntPtr max_vertices, UIntPtr min_triangles, UIntPtr max_triangles, float fill_weight);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern UIntPtr meshopt_partitionClusters(uint* destination, uint* cluster_indices, UIntPtr total_index_count, uint* cluster_index_counts, UIntPtr cluster_count, float* vertex_positions, UIntPtr vertex_count, UIntPtr vertex_positions_stride, UIntPtr target_partition_size);
		...
		/// </summary>
		[DllImport("meshoptimizer", CallingConvention = CallingConvention.Cdecl)]
		public static extern void meshopt_spatialClusterPoints(uint* destination, float* vertex_positions, UIntPtr vertex_count, UIntPtr vertex_positions_stride, UIntPtr cluster_size);
